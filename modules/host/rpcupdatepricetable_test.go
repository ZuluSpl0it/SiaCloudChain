...
func TestPriceTableMarshaling(t *testing.T) {
	pt := modules.RPCPriceTable{
		...
		UpdatePriceTableCost: types.ScPrimecoinPrecision,
		InitBaseCost:         types.ScPrimecoinPrecision.Mul64(1e2),
		MemoryTimeCost:       types.ScPrimecoinPrecision.Mul64(1e3),
		ReadBaseCost:         types.ScPrimecoinPrecision.Mul64(1e4),
		ReadLengthCost:       types.ScPrimecoinPrecision.Mul64(1e5),
		HasSectorBaseCost:    types.ScPrimecoinPrecision.Mul64(1e6),
		TxnFeeMinRecommended: types.ScPrimecoinPrecision.Mul64(1e7),
		TxnFeeMaxRecommended: types.ScPrimecoinPrecision.Mul64(1e8),
		DropSectorsBaseCost:  types.ScPrimecoinPrecision.Mul64(1e9),
		DropSectorsUnitCost:  types.ScPrimecoinPrecision.Mul64(1e10),
		WriteBaseCost:        types.ScPrimecoinPrecision.Mul64(1e11),
		WriteLengthCost:      types.ScPrimecoinPrecision.Mul64(1e12),
		WriteStoreCost:       types.ScPrimecoinPrecision.Mul64(1e13),
		LatestRevisionCost:   types.ScPrimecoinPrecision.Mul64(1e14),
		FundAccountCost:      types.ScPrimecoinPrecision.Mul64(1e15),
		AccountBalanceCost:   types.ScPrimecoinPrecision.Mul64(1e16),
		SwapSectorCost:       types.ScPrimecoinPrecision.Mul64(1e17),
	}
